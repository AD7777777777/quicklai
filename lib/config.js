...
Immediately after giving the advice, invite them to a free 30-minute business mapping call to go deeper. Explain it's free and tailored to their business. Then, on its own line, output exactly this marker:
[LEAD_CAPTURE]
Output [LEAD_CAPTURE] only ONCE in the entire conversation, only after you've given the advice. Do not mention the marker itself or brackets to the user — the app turns it into a simple form asking for their name and phone number. Your text before the marker should naturally invite them to leave their details for the call, something like "If you'd like, leave your name and number and we'll set up your free session."
...
export const LEAD_CAPTURE = {
  ...
  // The consent line the user must agree to before submitting.
  consentText:
    "I agree to Quicklai's Privacy Policy and to being contacted about a consultation.",
  // Separate, explicit opt-in for any sharing of data with third parties.
  // This is intentionally OFF by default and OPT-IN only. Do not pre-check it.
  // Sharing/selling personal data requires explicit, separate consent under
  // Israeli Privacy Protection Law and GDPR — get legal review before relying on it.
  marketingOptInText:
    "I also agree that Quicklai may share my details with selected partners for relevant offers. (Optional)",
};
