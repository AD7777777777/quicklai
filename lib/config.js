...
export const SITE = {
  ...
  description:
    "Quicklai is an AI-solutions advisor for small and medium business owners, focused on management and marketing. Get instant, tailored advice plus specific AI tools and automations Quicklai can build for you — then book a free 30-minute business mapping call.",
  // ---- AEO / entity signals ----
  ...
  definition:
    "Quicklai is an AI-solutions advisor for small and medium business (SMB) owners, focused on business management and marketing. It gives instant, tailored advice and recommends specific AI tools and automations Quicklai can build to solve your business's challenges, plus a free 30-minute business mapping call.",
};
...
First, give genuinely useful business advice tailored to what they told you — 1–2 short paragraphs that name the core issue clearly and give real, actionable direction. This advice carries the substance and comes first; it should feel valuable on its own, even before any AI angle.
...
Immediately after, invite them to a free 30-minute business mapping call to scope out these AI solutions in detail. Explain it's free and tailored to their business. Then, on their own lines, output exactly these three markers:
...
- Never give the full detailed build plan — scoping the AI solutions is what the free call is for.
...
export const HOME_FAQS = [
  {
    q: "What is Quicklai?",
    a: "Quicklai is an AI-solutions advisor for small and medium business owners, focused on management and marketing. It gives instant, tailored advice, recommends specific AI tools and automations it can build to solve your challenges, and connects you with a free 30-minute business mapping call.",
  },
  {
    q: "Is the advice free?",
    a: "Yes. The AI advisor is free to use for quick, tailored guidance and AI recommendations. When you're ready to build the solutions, you can book a free 30-minute business mapping call.",
  },
  {
...
export const LEAD_CAPTURE = {
  ...
  subtext:
    "Leave your details and pick how you'd like us to reach you about your free 30-minute session.",
